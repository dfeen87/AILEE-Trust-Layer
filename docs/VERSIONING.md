...
**All v4.6.0 code runs identically on v4.6.0+**
...
### v4.6.0 (December 17, 2025) — Major Release
...
|---------|--------|------------------|
| v2.0.x | **Current** | TBD |
| v1.1.x | Supported | Until v4.6.0 + 2 years |
| v1.0.x | Supported | Until v4.6.0 + 6 months |
...
- **Breaking changes require v4.6.0**
