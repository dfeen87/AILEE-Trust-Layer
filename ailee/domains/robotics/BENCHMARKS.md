...
python benchmark.py --export-json release_v4.7.0.json
```
...
**v4.7.0 - Enhanced Multi-Robot Testing**
...
```
Title: [PERF] Throughput degraded by 15% in v4.7.0
Include:
