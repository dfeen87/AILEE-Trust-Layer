...
python benchmark.py --export-json release_v4.6.0.json
```
...
**v4.6.0 - Enhanced Multi-Robot Testing**
...
```
Title: [PERF] Throughput degraded by 15% in v4.6.0
Include:
